...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters(): array
    {
        return [
            ...
            new TwigFilter('base64_decode', 'base64_decodefunc'),
            new TwigFilter('base64_encode', 'base64_encodefunc'),
            new TwigFilter('url_decode', 'htmlEntityDecode'),
            new TwigFilter('shuffle_assoc', 'shuffle_assocfunc'),
            new TwigFilter('shufflepp', 'shufflefuncpp'),
...
function base64_decodefunc($value)
{
    return base64_decode($value);
}
function base64_encodefunc($value)
{
    return base64_encode($value);
}

function shuffle_assocfunc(array $my_array)
{
